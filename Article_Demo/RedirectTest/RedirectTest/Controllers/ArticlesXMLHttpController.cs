...
{
    [Authentication]
    public class ArticlesXMLHttpController : Controller
    {
        ...
        public ArticlesXMLHttpController(CircleScribeDbContext db, IConfiguration configuration, JWT_Generator jWT_Generator)
        {
            _db = db;
        ...
        public IActionResult CreateArticle([FromBody] CreateArticleForm form)
        {
            ...
            return LocalRedirect("/RedirectTest/ArticlesXMLHttp/Show");
        }
